    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className='form-inner-wrap-right'>
          <MarkerLocationManager markerLocations={markerLocations} setMarkerLocations={setMarkerLocations} />
          <MarkerTextInput markerText={markerText} setMarkerText={setMarkerText} />
        </div>
        <SubmitButton />
      </form>
      <MapWrapper position={position} setPosition={setPosition} draggable={draggable} />
